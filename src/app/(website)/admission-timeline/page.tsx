            ...
            <div className="bg-white border-b border-slate-100 py-32 relative overflow-hidden">
                ...
                <Container className="relative z-10 text-center">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 border border-slate-800 text-white text-[10px] font-extrabold uppercase tracking-[0.3em] mb-8 shadow-xl shadow-slate-900/20"
                    >
                    ...
                    <motion.h1 
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="text-5xl md:text-8xl font-extrabold text-slate-900 tracking-tighter leading-[0.9] mb-8"
                    >
                        Your Roadmap <br />
                    ...
                    >
                        <Button size="lg" className="h-16 px-10 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-lg shadow-xl shadow-emerald-600/20 group" asChild>
                        ...
                        <div key={phase.id} className={`relative flex flex-col ${i % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-start lg:items-center gap-12 lg:gap-24`}>
                            ...
                            <div className="absolute left-[30px] lg:left-1/2 top-0 lg:top-1/2 -translate-x-1/2 lg:-translate-y-1/2 z-20 hidden md:block">
                                ...
                                >
                                    ...
                                    <div className="relative font-extrabold text-2xl">{phase.id}</div>
                                </motion.div>
                            </div>
                            ...
                            <div className="w-full lg:w-1/2 space-y-8">
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between mb-8">
                                        <div className={`px-4 py-2 rounded-full bg-${phase.color}-50 text-${phase.color}-700 text-[10px] font-extrabold uppercase tracking-widest`}>
                                            Phase 0{phase.id}
                                        </div>
                                    ...
                                    {phase.cta && (
                                        <Button size="lg" className={`w-full h-14 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-extrabold group`} asChild>
