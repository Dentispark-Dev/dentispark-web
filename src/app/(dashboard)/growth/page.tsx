    ...
    <div className="max-w-6xl mx-auto py-12 px-6 space-y-16">
      <div className="space-y-4">
        <div className="flex items-center gap-4">
            ...
            <h1 className="text-4xl font-extrabold text-black-900 tracking-tight">Growth & Rewards</h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 space-y-6">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-extrabold text-black-900 tracking-tight uppercase tracking-widest text-xs">Milestone Sharing</h2>
                </div>
                <h3 className="text-3xl font-extrabold text-black-900 leading-tight">Celebrate Your Wins Globally.</h3>
                ...
                <div className="flex gap-8">
                    <div className="space-y-1">
                        <p className="text-2xl font-extrabold text-primary-600 italic">5k+</p>
                        <p className="text-[10px] font-extrabold uppercase tracking-widest text-black-400">Cards Shared</p>
                    </div>
                    <div className="space-y-1">
                        <p className="text-2xl font-extrabold text-blue-600 italic">100%</p>
                        <p className="text-[10px] font-extrabold uppercase tracking-widest text-black-400">Viral Impact</p>
                    </div>
                </div>
            </div>
      ...
      <div className="glass-card p-12 rounded-[3.5rem] bg-black-900 text-white flex flex-col items-center text-center space-y-8 relative overflow-hidden">
        ...
        <div className="space-y-4 relative z-10">
            <h3 className="text-3xl font-extrabold tracking-tight">Going Institutional?</h3>
        ...
        <Link href="/contact-us" className="h-16 px-10 bg-white text-black-900 rounded-2xl font-extrabold uppercase tracking-widest text-xs hover:bg-primary-50 transition-all relative z-10 flex items-center justify-center">
