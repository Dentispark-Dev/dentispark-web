    ...
    <div className="glass-card p-10 rounded-[3rem] border-greys-100 space-y-8 relative overflow-hidden">
      <div className="flex justify-between items-start relative z-10">
        <div className="space-y-2">
            <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-black-400 uppercase tracking-widest">Active License</span>
            </div>
            <h3 className="text-2xl font-black text-black-900 tracking-tight">{license.name}</h3>
        </div>
        <button className="h-12 px-6 border border-greys-100 rounded-2xl flex items-center gap-2 text-xs font-black uppercase tracking-widest text-black-900 hover:bg-greys-50 transition-all">
      ...
      <div className="space-y-4 relative z-10">
        <div className="flex justify-between items-end">
            <div className="space-y-1">
                <p className="text-sm font-black text-black-900 tracking-tight">{license.usedSeats} / {license.totalSeats} Seats Occupied</p>
                <p className="text-xs text-black-400 font-medium italic">License expires on {license.expiryDate}</p>
            </div>
            <span className="text-2xl font-black italic text-primary-600">{Math.round(percentage)}%</span>
        </div>
      ...
      <div className="flex gap-4 relative z-10 pt-2">
        <div className="flex-1 p-6 rounded-[1.5rem] bg-amber-50 border border-amber-100 flex items-center gap-4">
            ...
            <div>
                <p className="text-xs font-black text-amber-900 uppercase tracking-widest">Low Seat Alert</p>
