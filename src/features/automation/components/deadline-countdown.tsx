...
export function DeadlineCountdown() {
  ...
  return (
    <div className={cn(
        ...
        <div className="flex items-center gap-6 xl:w-1/3">
            ...
            <div>
                <div className="flex items-center gap-2 mb-1">
                    ...
                    {isCritical && (
                        <span className="px-2 py-0.5 rounded-full bg-red-100 text-red-600 text-[9px] font-bold uppercase tracking-widest animate-pulse">
                            Critical
                        </span>
                    )}
                </div>
        ...
        <div className="flex items-center gap-4 xl:w-1/3 justify-center">
