    ...
    <div className={cn(
        ...
        <div className="flex items-center gap-6 flex-[1_1_320px] min-w-[320px]">
            ...
            <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 mb-1">
                    <span className={cn(
                        "text-[10px] font-extrabold uppercase tracking-widest truncate",
        ...
        <div className="flex items-center gap-4 shrink-0 justify-center">
            <div className="flex items-baseline gap-2 bg-slate-50 px-6 py-4 rounded-2xl border border-slate-100">
                <span className={cn("text-4xl font-extrabold", isCritical ? "text-red-600" : "text-slate-900")}>
                    {timeLeft.days}
                </span>
                <span className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400">Days</span>
            </div>
            <div className="flex items-center gap-6 px-6 py-4 rounded-2xl">
                <div className="text-center">
                    <p className="text-2xl font-extrabold text-slate-700">{String(timeLeft.hours).padStart(2, '0')}</p>
                    <p className="text-[9px] font-extrabold text-slate-400 uppercase tracking-widest">Hrs</p>
                </div>
                <span className="text-slate-300 font-bold">:</span>
                <div className="text-center">
                    <p className="text-2xl font-extrabold text-slate-700">{String(timeLeft.minutes).padStart(2, '0')}</p>
                    <p className="text-[9px] font-extrabold text-slate-400 uppercase tracking-widest">Min</p>
                </div>
                <span className="text-slate-300 font-bold">:</span>
                <div className="text-center">
                    <p className="text-2xl font-extrabold text-slate-700">{String(timeLeft.seconds).padStart(2, '0')}</p>
                    <p className="text-[9px] font-extrabold text-slate-400 uppercase tracking-widest">Sec</p>
                </div>
            </div>
        </div>
        ...
        <div className="shrink-0 flex justify-end mt-4 xl:mt-0">
            <Link href="/applications/checklist" className="w-full xl:w-auto">
                <button className={cn(
                    "w-full xl:w-auto h-14 px-8 rounded-xl font-extrabold uppercase tracking-widest transition-all flex items-center justify-center gap-2",
                    isCritical 
