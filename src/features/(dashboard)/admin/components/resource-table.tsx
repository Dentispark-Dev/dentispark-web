    ...
    return (
        <div className="space-y-10 pb-20">
            ...
            <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-greys-300 flex flex-col xl:flex-row gap-8 justify-between items-center relative overflow-hidden shadow-sm">
                <div className="absolute top-0 right-0 h-48 w-48 bg-orange-50 rounded-bl-full opacity-40 pointer-events-none" />
                
                <div className="relative z-10 space-y-3 w-full xl:w-auto">
                    <div>
                        <Badge variant="outline" className="bg-orange-50 text-orange-600 border-orange-200 px-4 py-1.5 font-extrabold text-[11px] tracking-[0.3em] rounded-full uppercase mb-3 leading-none inline-flex font-jakarta">
                            Resource Library
                        </Badge>
                        <h2 className="text-3xl md:text-4xl font-semibold text-text-heading tracking-tight font-jakarta leading-tight">Knowledge <span className="text-orange-600">Base</span></h2>
                    </div>
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full xl:w-auto relative z-10">
                    <div className="relative group flex-1 xl:flex-none">
                        ...
                        <Input
                            ...
                            className="pl-14 pr-8 h-12 w-full xl:w-[400px] bg-greys-100 border-greys-300 text-text-heading placeholder:text-greys-400 focus:bg-white focus:ring-4 focus:ring-orange-500/10 focus:border-orange-600/50 rounded-2xl transition-all font-medium text-sm font-jakarta"
                            value={searchInput}
                    ...
                    <table className="w-full text-left border-separate border-spacing-0">
                        <thead>
                            <tr className="bg-greys-100/50">
                                <th className="pl-12 pr-6 py-5 text-[10px] font-bold text-greys-400 uppercase tracking-[0.2em] font-jakarta">Resource Hub</th>
                                <th className="px-6 py-5 text-[10px] font-bold text-greys-400 uppercase tracking-[0.2em] font-jakarta">Pathway</th>
                                <th className="px-6 py-5 text-[10px] font-bold text-greys-400 uppercase tracking-[0.2em] font-jakarta">Author/Type</th>
                                <th className="px-6 py-5 text-[10px] font-bold text-greys-400 uppercase tracking-[0.2em] font-jakarta">Node Created</th>
                            ...
                            {isLoading ? (
                                ...
                                resources.map((res) => (
                                    ...
                                    >
                                        <td className="pl-12 pr-6 py-6">
                                            <div className="flex items-center gap-5">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-base font-semibold text-text-heading group-hover:text-orange-600 transition-colors tracking-tight mb-0.5 font-jakarta">{res.title}</p>
                                        ...
                                        <td className="px-6 py-6 font-jakarta">
                                            <Badge variant="outline" className="bg-white text-greys-600 border-greys-200 px-4 py-1.5 font-bold text-[10px] tracking-widest rounded-full group-hover:bg-greys-50 transition-colors uppercase">
                                        ...
                                        <td className="px-6 py-6 font-jakarta">
                                            <div className="flex items-center gap-3 text-greys-500">
                                                <div className="h-10 w-10 rounded-xl bg-white border border-greys-300 flex items-center justify-center shadow-xs">
                                                    <Clock className="h-4 w-4 text-greys-300" />
                                                </div>
