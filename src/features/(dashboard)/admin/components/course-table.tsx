                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-gray-50/50 border-b border-gray-100">
                                    ...
                                    <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Degree</th>
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {isLoading ? (
                                    ...
                                    courses.map((course) => (
                                        <tr key={course.hid} className="hover:bg-gray-50/50 transition-colors group">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-gray-500">{course.hid}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        <DropdownMenuItem onClick={() => window.location.href = `/admin/content/courses/${course.hid}`}>
                                                            Edit Details
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onClick={() => deleteMutation.mutate(course.hid)} className="text-red-600">
                                                            Delete
                                                        </DropdownMenuItem>
                                                    </DropdownMenuContent>
                                                </DropdownMenu>
